...
// Recoloca al jugador
//if(i < global.Posicion_i) { Direccion = "izquierda"; obj_Jugador.x = 520-64-24; obj_Jugador.y = 184-20; if(control_Dungeon.Dungeon[i,j]==1 or (global.Mapa_Tipo = 6 and control_Dungeon.Dungeon[i,j]==3)){ obj_Jugador.x+=72-72; } }
//if(i > global.Posicion_i) { Direccion = "derecha"; obj_Jugador.x = 112+58+24; obj_Jugador.y = 184-20; if(control_Dungeon.Dungeon[i,j]==1 or (global.Mapa_Tipo = 6 and control_Dungeon.Dungeon[i,j]==3)){ obj_Jugador.x-=72-72; } }
//if(j > global.Posicion_j) { Direccion = "abajo"; obj_Jugador.x = 320-8 ; obj_Jugador.y = 112-18+24; if(control_Dungeon.Dungeon[i,j]==1 or (global.Mapa_Tipo = 6 and control_Dungeon.Dungeon[i,j]==3)){ obj_Jugador.y-=72-72; } }
//if(j < global.Posicion_j) { Direccion = "arriba"; obj_Jugador.x = 320-8 ; obj_Jugador.y = 240-4-24 ; if(control_Dungeon.Dungeon[i,j]==1 or (global.Mapa_Tipo = 6 and control_Dungeon.Dungeon[i,j]==3)){ obj_Jugador.y+=72-72; } }
...
if( control_Dungeon.Dungeon[ global.Posicion_i, global.Posicion_j ] == 3 ) {
    if ( control_Dungeon.Dungeon_Boss != -1 ) {
        ...
        Room = room_Jefe; // Jefe  
		if(global.Mapa_Tipo == 14) Room = room_Jefe_Mimic;
    }
}

...
Velocidad = get_enemy(ID, 2);
actionColor = get_enemy(ID, 23);
actionTimeMax = get_enemy(ID, 24);
Immune = get_enemy(ID,25);
if(real(ID) == 44) and (player_has_pet(65)) Immune = false; 
if(actionTimeMax > 0) actionTimeMax += -15 + random(30)

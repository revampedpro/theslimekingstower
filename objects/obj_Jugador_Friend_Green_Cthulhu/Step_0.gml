...
// Disparar
alarm[0] = 10;
//var Spray = scr_jugador_common_disparo(Angulo_2, 0.5+(random(15)/10), sprBulletSpray);
var Spray = bullet_spawn(x,y,0.5+(random(15)/10),0.5+(random(15)/10),Angulo_2,obj_Jugador_Disparo,sprBulletSpray);
//Spray.sprite_index = sprBulletSpray;
//Spray.image_xscale += random(5)/10;
//Spray.image_yscale += random(5)/10;
//Spray.image_alpha = 0.6 + random(4)/10;

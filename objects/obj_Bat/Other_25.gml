...
// Gigadusas' Bonus
if(ID == 5) {
    if(obj_Jugador.Pet_Bonus_Boss_Gigadusa) { instance_create(x,y,obj_Moneda); instance_destroy(); }
    if(obj_Jugador.Pet_Bonus_Boss_GreenGigadusa) { instance_create(x,y,obj_Salud); instance_destroy(); }
}

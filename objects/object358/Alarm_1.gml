...
if(!position_meeting(x+16,y,obj_Light_Environment)) { instance_create(x+16,y,obj_Light_Environment); }
if(!position_meeting(x-16,y,obj_Light_Environment)) { instance_create(x-16,y,obj_Light_Environment); }
if(!position_meeting(x,y+16,obj_Light_Environment)) { instance_create(x,y+16,obj_Light_Environment); }
if(!position_meeting(x,y-16,obj_Light_Environment)) { instance_create(x,y-16,obj_Light_Environment); }

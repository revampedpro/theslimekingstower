...
ini_open("save.ini");
var pre = ini_read_real("BRU","B",false);
ini_write_real("BRU","B",true);

if(ini_read_real("BRU","A",false) == true) and (pre == false) {
...
// Unlock Trapped
if(!check_character_unlocked(13,0)) unlock_character(13);

// Unlock progression
unlock_character_progression(5,global.characterSelected);
